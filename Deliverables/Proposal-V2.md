...
|---------|------|--------|---------|---------------|
| 1.0 | Dec 25, 2025 | DOS Team | Initial proposal | Draft - Pending Client Review |
...
- **Purchase-Based Missions:** Shopping at partner locations with receipt validation
- **Social Missions:** Share content, invite friends, engage on social media
...
**Technical Highlights:**
- Web-based responsive interface (React/Vue.js)
...
- Blockchain-based point ledger (optional)
...
- Multi-deployment capability for 3+ white-label clients
...
### 4.1 Mobile Applications (Customer & Partner Apps)

**Framework:** Flutter

**Rationale:**
- Single codebase for iOS and Android (reduced development time and cost)
- Native performance comparable to Swift/Kotlin
- Rich UI component library
- Strong community and Google backing
- Excellent for location-based applications
...
### 4.2 Admin Console (Web Application)
...
- Excellent for data-heavy admin interfaces
- Strong developer availability in Thailand
...
- Familiar to Thai developer market
...
- Real-time features via Pusher integration
- Background job processing (Laravel Queues)
- API documentation (Swagger/OpenAPI)

### 4.4 Database & Data Storage

**Primary Database:** PostgreSQL
- Relational data integrity for points and transactions
- Complex query support for analytics
- Mature ecosystem and tooling
- Excellent support in Laravel

**Secondary Database:** MongoDB
- Flexible schema for dynamic mission configurations
- Efficient storage for logs and analytics data
- Scalable for high-volume data

**Supplementary Storage:**
- **Redis:** Caching and session management
- **Cloud Storage:** Images, documents (GCP Cloud Storage)
...
**Rationale:**
- Excellent location services integration
- Competitive pricing for Asian region
- Strong AI/ML capabilities for future phases
- Proven DOS team expertise

**Core Services:**
- Compute: Google Kubernetes Engine (GKE) / Cloud Run
- Database: Cloud SQL (PostgreSQL) + MongoDB Atlas
- Storage: Cloud Storage
- Functions: Cloud Functions for serverless tasks
- Monitoring: Cloud Monitoring / Cloud Logging

### 4.6 Third-Party Services

**Maps & Location:**
- Google Maps Platform (Geocoding, Geofencing, Places API)

**Notifications & Real-time:**
- OneSignal (Push Notifications)
- Pusher (Real-time database updates)
...
**Payment (Future):**
- Stripe / OPN / 2C2P (for premium features)
...
Breakdown:
- Development (60%): THB 600,000
- Infrastructure (15%): THB 150,000
- Testing & QA (10%): THB 100,000
- Project Management (15%): THB 150,000

**Phase 2 (MVP): THB 3,000,000 - 5,000,000**

Breakdown:
- Development (55%): THB 1,650,000 - 2,750,000
- Infrastructure & Cloud (15%): THB 450,000 - 750,000
- Testing & Security (12%): THB 360,000 - 600,000
- Design & UX (8%): THB 240,000 - 400,000
- Project Management (10%): THB 300,000 - 500,000

**Phase 3 (Full Scale): THB ~10,000,000**

Breakdown:
- Advanced Development (50%): THB 5,000,000
- AI/ML & Analytics (15%): THB 1,500,000
- Infrastructure & Scaling (15%): THB 1,500,000
- Security & Compliance (10%): THB 1,000,000
- Testing & QA (5%): THB 500,000
- Project Management (5%): THB 500,000
...
- Strong cloud infrastructure expertise (GCP, AWS)
...
We strongly recommend cloud hosting (GCP/AWS) for optimal performance, reliability, and cost-effectiveness. If required, we can provide a hybrid model or assess on-premise feasibility separately.
